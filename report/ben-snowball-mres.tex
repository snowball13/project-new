...
\cite{gallouet2016lagrangian} used a symplectic method (symplectic Euler) to discretise (7, 8) in time. For intial conditions \((m^0, u^0) \in \MN \times \MN \), the algorithm is as follows:
\begin{flalign*}
 & \quad
 \begin{cases}
